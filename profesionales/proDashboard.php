...
<div class="container mt-5">
    ...
    <div class="row text-center">
        <div class="col-md-4 mb-3">
            <a href="asignacion.php" class="btn btn-primary btn-lg w-100">Consulta, tratamiento</a>
        </div>
        <div class="col-md-4 mb-3">
        ...
        <div class="col-md-4 mb-3">
            <a href="asignarMisiones.php" class="btn btn-primary btn-lg w-100">Asignar Misiones</a>
        </div>
